...
class WeeklyAbsenceReportServiceImplTest {
    ...
    @InjectMocks
    private WeeklyAbsenceReportServiceImpl weeklyAbsenceReportService;
    ...
    void testGenerateWeeklyReport_Success() {
        ...
        when(sessionRepository.findByClassroomClassIdAndDateBetween(eq(classroomId), any(LocalDate.class), any(LocalDate.class))).thenReturn(Collections.emptyList());

        // When
        ByteArrayInputStream pdfStream = weeklyAbsenceReportService.generateWeeklyReport(classroomId, weekStart);
